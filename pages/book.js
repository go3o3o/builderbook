    ...
    <div style={{ padding: "10px 8%", fontSize: "15px" }}>
      <Grid container direction="row" justify="space-around" align="flex-start">
        <Grid item sm={12} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            Learn how to build a full-stack JavaScript web application from
            scratch.
            <br />
            You&apos;ll go from 0 lines of code in Chapter 1 to over 12,000
            lines of code by Chapter 8.
          </p>
      ...
      <Grid container direction="row" justify="space-around" align="flex-start">
        <Grid item sm={6} xs={12} style={styleHomepageFeature}>
          ...
          <p>
            Learn how to build a web app with React, Material-UI, Next, Express,
            Mongoose, and MongoDB. We keep our book up-to-date with the latest
            versions.
          </p>
        </Grid>
        <Grid item sm={6} xs={12} style={styleHomepageFeature}>
          ...
          <p>
            Learn how to integrate a web app with Google for user
            authentication, Github for markdown and collaboration, AWS SES for
            transactional emails, MailChimp for newsletters, and Stripe for
            selling.
          </p>
        </Grid>
      </Grid>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        . Stay tuned for
        <a
          href="https://github.com/builderbook/async"
          target="_blank"
          rel="noopener noreferrer"
        >
          {" "}
      ...
      <Grid container direction="row" justify="space-around" align="flex-start">
        ...
        <Grid item sm={6} xs={12} style={styleAuthor}>
          ...
          <p>
            Kelly is a front-end developer. She likes using React and Material
            Design and enjoys solving UX problems.
          </p>
        </Grid>
      </Grid>
...
export default withAuth(withLayout(Book, { noHeader: true }), {
  loginRequired: false,
});
