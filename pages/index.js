    ...
    <div style={{ padding: "10px 45px" }}>
      ...
      >
        <Grid item sm={12} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            <b>Third party APIs:</b> AWS SES, Github, Google OAuth
            (Passport.js), Stripe, MailChimp.
          </p>
        </Grid>
      </Grid>
      ...
      >
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            {" "}
            Write and share blog posts, get subscribers, and send them
            newsletters.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            {" "}
            Write project documentation with Markdown and host it all on Github.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          <p>
      ...
      >
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            Write blogs, documentation, and books with Markdown. Write directly
            on Github or your favorite code editor.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          <p>
        ...
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            Integrated with AWS SES to send customized transactional emails to
        ...
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            Integrated with MailChimp to create mailing lists for different
            types of subscribers and customers.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          <p>
          ...
          <p>
            {" "}
            Integrated with Stripe to create a simple checkout for book
            customers.{" "}
          </p>
        </Grid>
      </Grid>
      ...
      <p style={{ display: "none" }}>
        ...
        <Hidden only="xs">
          ...
          <p style={{ textAlign: "center" }}>
            Our book is ideal for junior developers who want to learn how to
            build a web app from scratch.
          </p>
          <p style={{ textAlign: "center" }}>
            You should know fundamentals of HTML, CSS, and JavaScript.
            Experience with React is helpful but not a must-have.
          </p>
        </Hidden>
      ...
      >
        ...
        >
          ...
          <p>
            Tima is a full-stack web developer. He enjoys learning Javascript
            frameworks and building useful web apps.
          </p>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <p>
            Kelly is front-end developer. She likes React and enjoys solving UX
            problems in web apps.
          </p>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <p>
            Del is a back-end developer. He built many production-ready web apps
      ...
      >
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            ...
            on Github to install the code, run it locally, and deploy it to a
            live site.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          ...
          <p>
            Yes, we use the latest versions of all frameworks, libraries, and
            services. We regularly check for updates.
          </p>
        </Grid>
        <Grid item sm={4} xs={12} style={{ textAlign: "center" }}>
          <p>
          ...
          <p>
            ...
            to report bugs, ask questions, or make suggestions about this
            project or our book.
          </p>
        </Grid>
        <Grid
        ...
        >
          ...
          <p>
            ...
            and an excerpt at the beginning of every chapter are available to
            read for free.
          </p>
        </Grid>
        <Grid
        ...
        >
          ...
          <p>
            {" "}
            As Techstars founders (Atlanta '16), we're giving back by offering a
            free copy to other Techstars founders.
            <a href="mailto:team@rbuilderbook.org"> Email us</a> your name,
            company, and Techstars batch.
          </p>
        </Grid>
      </Grid>
...
export default withAuth(withLayout(Index, { noHeader: true }), {
  loginRequired: false,
});
